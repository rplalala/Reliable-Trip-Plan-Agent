...
def test_prompt_and_capture_version_wiring():
    ...
    assert "preference_prompt_8" in inspect.getsource(boundary_identity)
    assert "preference_prompt_8" in inspect.getsource(AzureFoundryStructuredLLMClient._interpret)
